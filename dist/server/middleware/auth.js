    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!token) {
                    return [2 /*return*/, res.status(401).json({ error: 'Token de acesso necessário' })];
                }
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
            ...
            case 3:
                error_1 = _a.sent();
                return [2 /*return*/, res.status(403).json({ error: 'Token inválido' })];
            case 4: return [2 /*return*/];
        }
    });
}); };
export var requireRole = function (allowedRoles) {
...
export var requireAdmin = requireRole(['admin']);
export var requireManagement = requireRole(['admin', 'management']);
